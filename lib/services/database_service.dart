...
class DBService{
  ...
  Future<void> createOrGetConversartion(String _currentID, String _recepintID,
    ...
    try {
      var conversation =
      await _userConversationRef.document(_recepintID).get();
      if (conversation.data != null) {
        ...
        await _conversationRef.setData(
          {
            "members": [_currentID, _recepintID],
            "ownerID": _currentID,
            'messages': [],
          },
        );
